...
const Mypage = () => {
  ...
  return (
    <section className={` w-full ${isSidebarOpen ? 'lg:ml-[45vh] ' : ''} lg:ml-8  mt-20`}>
      ...
      <div className={`h-44 w-full border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} flex items-center px-28 `}>
        shorts
        <div className="flex items-center space-x-6 max-w-4xl w-full">
          <div className={`h-24 w-24 rounded-full ${isDarkMode ? 'bg-gray-700' : 'bg-gray-300'} flex items-center justify-center text-2xl font-bold`}>
            SE
          </div>
