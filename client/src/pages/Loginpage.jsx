  ...
  return (
    <div className="flex justify-center items-center flex-col bg-black min-h-screen font-['Montserrat'] p-4">
      ...
      >
        ...
        >
          <form className="bg-white flex flex-col items-center justify-center md:px-12 px-8 h-full text-center">
           ...
           <button
            ...
            <button className="rounded-full bg-red-500 text-white text-xs font-bold py-3 px-8 md:px-12 my-2 uppercase tracking-wider border border-red-500 hover:bg-red-600 transition">
              Sign Up
            </button>
          </form>
